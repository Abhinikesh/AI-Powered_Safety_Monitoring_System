...
def generate_metrics_doc():
    """Generates a detailed markdown report of YOLOv8 model metrics on the Construction Site Safety dataset."""
    metrics_path = REPORT_DIR / "model_metrics.md"

    content = """# YOLOv8 Construction Site Safety Model Metrics & Evaluation
...
"""
    ...
    print(f"✓ Generated Construction Site Safety metrics summary at: {metrics_path}")
